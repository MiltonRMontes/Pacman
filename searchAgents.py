...
class SearchAgent(Agent):
    ...
    def registerInitialState(self, state):
        ...
        self.totalCost = problem.getCostOfActions(self.actions)
        self.expandidos = problem._expanded
        print('Path found with total cost of %d in %.1f seconds' % (self.totalCost, time.time() - starttime))
...
def first(position, problem, info={}):
    xy1 = position
    xy2 = problem.goal
